(function () {
  const simplyMeet = "https://app.simplymeet.me/hermenceubuntuworkforce";
  const linkedin = "https://www.linkedin.com/in/hermencematsotsa-transformationalleadershipstrategist/";
  const email = "hermence@ubuntuworkforce.com";
  ...
  const translations = {
    en: {
      ...
      heroHeadline: "Your ERG Deserves More Than Another Meeting.",
      heroSubhead: "The uBuntu Power Hour Experience turns your next ERG gathering into a space where people feel seen, heard, and re-energized to lead in 60 minutes.",
      ...
      solutionLabel: "Introducing",
      solutionHeadline: "The uBuntu Power Hour Experience",
      solution1: "The uBuntu Power Hour Experience is a 60-minute interactive facilitation experience: not a lecture, not a keynote, not a sit-back-and-listen session.",
      solution2: "It is a guided, discussion-based experience where your team actually talks to each other. Across difference. Across seniority. Across everything that usually keeps people quiet.",
      solution3: "Participants leave thinking differently, communicating differently, and leading differently.",
      solutionCta: "See If a Power Hour Is Right for Your Team",
      everyPower: "Every Power Hour is:",
      power1: "Fully facilitated, no prep required from your team",
      power2: "Discussion-based and psychologically safe",
      power3: "Customized to your team's context and goals",
      power4: "Available virtually or in person",
      power5: "Deliverable in English, Spanish, or French",
      ubuntuLabel: "The Philosophy Behind the Work",
      ubuntuHeadline: "\"I Am Because We Are.\"",
      ...
      sessionGroups: [
        ...
        },
        {
          ...
          cards: [
            ...
            ["Leading and Collaborating Across Cultures and Distance", "", "Strengthen global team communication, cultural intelligence, collaboration across differences, and inclusive meeting environments."],
      ...
      formatsHeadline: "One Hour. Endless Possibilities.",
      ...
      formats: [
        ...
        ["Global Team Discussion", "Facilitated across languages and time zones for multinational teams."],
        ["Wellness & Mental Fitness Experience", "Because sustainable leadership starts from the inside out."]
      ],
      ...
      aboutSub: "Transformational Leadership Strategist, Facilitator, and Global Speaker Helping High-Performing Professionals and Teams Turn Conversation Into Connection, Trust, and Impact",
      about1: "Hermence Matsotsa is not your typical facilitator.",
      ...
      finalHeadline: "Your Next Conversation Could Change Everything.",
      ...
      footerQuote: "\"I am because we are.\"",
      copyright: "© 2026 uBuntuSpeaks. All rights reserved."
    },
    es: {
      title: "uBuntu Power Hour Experience",
      ...
      solutionLabel: "Presentamos",
      solutionHeadline: "La experiencia Power Hour",
      solution1: "La uBuntu Power Hour Experience es una experiencia interactiva de facilitación de 60 minutos: no una conferencia, no una charla magistral, no una sesión pasiva.",
      solution2: "Es una experiencia guiada y basada en conversación donde tu equipo realmente habla entre sí. A través de diferencias. A través de jerarquías. A través de todo lo que normalmente mantiene a las personas calladas.",
      solution3: "Los participantes salen pensando, comunicándose y liderando de manera diferente.",
      solutionCta: "Ver si una Power Hour es adecuada para tu equipo",
      everyPower: "Cada Power Hour es:",
      power1: "Totalmente facilitada, sin preparación requerida de tu equipo",
      power2: "Basada en conversación y psicológicamente segura",
      power3: "Personalizada al contexto y objetivos de tu equipo",
      power4: "Disponible virtualmente o en persona",
      power5: "Disponible en inglés, español o francés",
      ubuntuLabel: "La filosofía detrás del trabajo",
      ubuntuHeadline: "\"Soy porque somos.\"",
      ...
      formatsHeadline: "Una hora. Posibilidades infinitas.",
      ...
      formats: [
        ...
        ["Diálogo de equipo global", "Facilitado entre idiomas y zonas horarias para equipos multinacionales."],
        ["Experiencia de bienestar y mental fitness", "Porque el liderazgo sostenible empieza desde adentro."]
      ],
      ...
      aboutHeadline: "Hermence Matsotsa",
      aboutSub: "Estratega de liderazgo transformacional, facilitadora y conferencista global que ayuda a profesionales y equipos de alto rendimiento a convertir la conversación en conexión, confianza e impacto.",
      about1: "Hermence Matsotsa no es una facilitadora típica.",
      ...
      finalHeadline: "Tu próxima conversación podría cambiarlo todo.",
      ...
      footerQuote: "\"Soy porque somos.\"",
      copyright: "© 2026 uBuntuSpeaks. Todos los derechos reservados."
    },
    fr: {
      title: "uBuntu Power Hour Experience",
      ...
      solutionLabel: "Présentation",
      solutionHeadline: "L'expérience Power Hour",
      solution1: "La uBuntu Power Hour Experience est une expérience interactive de facilitation de 60 minutes: pas une conférence, pas un keynote, pas une session passive.",
      solution2: "C'est une expérience guidée et basée sur la discussion où votre équipe se parle réellement. À travers les différences. À travers les niveaux hiérarchiques. À travers tout ce qui garde habituellement les personnes silencieuses.",
      solution3: "Les participants repartent en pensant, en communiquant et en dirigeant autrement.",
      solutionCta: "Voir si une Power Hour convient à votre équipe",
      everyPower: "Chaque Power Hour est:",
      power1: "Entièrement facilitée, sans préparation requise de votre équipe",
      power2: "Basée sur la discussion et psychologiquement sécurisante",
      power3: "Personnalisée selon le contexte et les objectifs de votre équipe",
      power4: "Disponible en virtuel ou en présentiel",
      power5: "Disponible en anglais, espagnol ou français",
      ubuntuLabel: "La philosophie derrière le travail",
      ubuntuHeadline: "\"Je suis parce que nous sommes.\"",
      ...
      formatsLabel: "Formats",
      formatsHeadline: "Une heure. Des possibilités infinies.",
      ...
      formats: [
        ...
        ["Discussion d'équipe mondiale", "Facilitée à travers les langues et fuseaux horaires pour les équipes multinationales."],
        ["Expérience bien-être et fitness mental", "Parce que le leadership durable commence de l'intérieur."]
      ],
      ...
      aboutHeadline: "Hermence Matsotsa",
      aboutSub: "Stratège en leadership transformationnel, facilitatrice et conférencière mondiale qui aide les professionnels et les équipes performantes à transformer la conversation en connexion, confiance et impact.",
      about1: "Hermence Matsotsa n'est pas une facilitatrice typique.",
      ...
      finalHeadline: "Votre prochaine conversation pourrait tout changer.",
      ...
      footerQuote: "\"Je suis parce que nous sommes.\"",
      copyright: "© 2026 uBuntuSpeaks. Tous droits réservés."
    }
  };
  ...
  const setLanguage = (lang) => {
    ...
    setText(".site-header nav a:nth-child(1)", t.navPower);
    setText(".site-header nav a:nth-child(2)", t.navTopics);
    setText(".site-header nav a:nth-child(3)", t.navAbout);
    setText(".site-header nav a:nth-child(4)", t.navBook);
    setText(".hero h1", t.heroHeadline);
    setText(".hero-subhead", t.heroSubhead);
    setText(".hero-support", t.heroSupport);
    setText(".hero .button", t.bookDiscovery);
    setText(".problem .section-label", t.problemLabel);
    setText(".problem h2", t.problemHeadline);
    setText(".problem p:nth-of-type(1)", t.problem1);
    setText(".problem p:nth-of-type(2)", t.problem2);
    setText(".problem p:nth-of-type(3)", t.problem3);
    setText(".problem p:nth-of-type(4)", t.problem4);

    setText("#power-hours .section-label", t.solutionLabel);
    setText("#power-hours h2", t.solutionHeadline);
    setText("#power-hours > .section-inner > div:first-child p:nth-of-type(1)", t.solution1);
    setText("#power-hours > .section-inner > div:first-child p:nth-of-type(2)", t.solution2);
    setText("#power-hours > .section-inner > div:first-child p:nth-of-type(3)", t.solution3);
    setText("#power-hours .button", t.solutionCta);
    setText(".feature-panel h3", t.everyPower);
    document.querySelectorAll(".check-list li").forEach((item, index) => {
      item.textContent = [t.power1, t.power2, t.power3, t.power4, t.power5][index];
    });

    setText(".ubuntu .section-label", t.ubuntuLabel);
    setText(".ubuntu h2", t.ubuntuHeadline);
    document.querySelectorAll(".ubuntu .split > div:last-child p:not(.section-label)").forEach((item, index) => {
      item.textContent = [t.ubuntu1, t.ubuntu5, t.ubuntu2, t.ubuntu3, t.ubuntu4][index];
    });

    setText(".session-breakdown .section-label", t.sessionLabel);
    setText(".session-breakdown .section-heading h2", t.sessionHeadline);
    document.querySelectorAll(".session-group").forEach((group, groupIndex) => {
      const groupContent = t.sessionGroups && t.sessionGroups[groupIndex];
      if (!groupContent) return;
      group.querySelector("h3").textContent = groupContent.title;
      group.querySelectorAll(".session-card").forEach((card, cardIndex) => {
        const cardContent = groupContent.cards[cardIndex];
        if (!cardContent) return;
        const title = card.querySelector("h4");
        const subtitle = card.querySelector(".session-subtitle");
        const body = subtitle ? subtitle.nextElementSibling : card.querySelector("p");
        title.textContent = cardContent[0];
        if (subtitle) subtitle.textContent = cardContent[1];
        if (body) body.textContent = cardContent[2];
      });
    });
    setText(".custom-session-callout h3", t.customSessionTitle);
    setText(".custom-session-callout p", t.customSessionText);
    setText(".custom-session-callout .button", t.customSessionCta);

    setText(".formats .section-label", t.formatsLabel);
    setText(".formats h2", t.formatsHeadline);
    setText(".formats .split > div:first-child p:last-child", t.formatsIntro);
    document.querySelectorAll(".format-list p").forEach((item, index) => {
      const content = t.formats[index];
      if (content) item.innerHTML = `<strong>${content[0]}</strong>: ${content[1]}`;
    });

    setText(".audience .section-label", t.audienceLabel);
    setText(".audience h2", t.audienceHeadline);
    document.querySelectorAll(".audience-card").forEach((card, index) => {
      const content = t.audience[index];
      if (!content) return;
      card.querySelector("h3").textContent = content[0];
      card.querySelector("p").textContent = content[1];
    });

    setText(".testimonials .section-label", t.testimonialLabel);
    setText(".testimonials h2", t.testimonialHeadline);
    document.querySelectorAll(".testimonial-grid figure").forEach((figure, index) => {
      const content = t.testimonials[index];
      if (!content) return;
      figure.querySelector("blockquote").textContent = content[0];
      figure.querySelector("figcaption").textContent = content[1];
    });

    setText(".investment .section-label", t.investmentLabel);
    setText(".investment h2", t.investmentHeadline);
    setText(".investment .section-heading p:nth-of-type(1)", t.investment2);
    document.querySelectorAll(".price-card").forEach((card, index) => {
      const content = t.prices[index];
      if (!content) return;
      card.querySelector("h3").textContent = content[0];
      card.querySelector("p").textContent = content[1];
      card.querySelector(".price").textContent = content[2];
    });
    setText(".investment .note", t.note);
    setText(".investment .button", t.fitCta);

    setText(".about .section-label", t.aboutLabel);
    setText(".about h2", t.aboutHeadline);
    setText(".about .subhead", t.aboutSub);
    const aboutParagraphs = document.querySelectorAll(".about .split > div:last-child p:not(.section-label):not(.subhead)");
    [t.about1, t.about2, t.about3, t.about4, t.about5, t.about6, t.about7].forEach((text, index) => {
      if (aboutParagraphs[index]) aboutParagraphs[index].textContent = text;
    });
    setText(".about .button", t.aboutCta);

    setText(".final-cta h2", t.finalHeadline);
    setText(".final-cta p:nth-of-type(1)", t.final1);
    setText(".final-cta p:nth-of-type(2)", t.final2);
    setText(".final-cta p:nth-of-type(3)", t.final3);
    setText(".final-cta p:nth-of-type(4)", t.final4);
    setText(".final-cta .button", t.finalCta);
    setText(".site-footer h2", t.footerTitle);
    setText(".site-footer .footer-inner > div:first-child p:nth-of-type(1)", t.footerBy);
    setHTML(".site-footer .footer-inner > div:first-child p:nth-of-type(2)", `<a href="mailto:${email}">${email}</a><a class="linkedin-icon" href="${linkedin}" aria-label="LinkedIn"><svg viewBox="0 0 24 24" aria-hidden="true" focusable="false"><path d="M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2ZM8.3 18H5.9V9.8h2.4V18ZM7.1 8.7c-.8 0-1.4-.6-1.4-1.4S6.3 6 7.1 6s1.4.6 1.4 1.3c0 .8-.6 1.4-1.4 1.4ZM18.1 18h-2.4v-4c0-1-.4-1.7-1.3-1.7-.7 0-1.1.5-1.3.9-.1.2-.1.4-.1.6V18h-2.4V9.8H13v1.1c.3-.5 1-1.3 2.4-1.3 1.8 0 2.7 1.2 2.7 3.6V18Z"></path></svg></a>`);
    setText(".footer-quote", t.footerQuote);
    setText(".site-footer .footer-inner > div:last-child p:last-child", t.copyright);
  ...
  setLanguage(window.localStorage.getItem("preferredLanguage") || "en");
})();
